...
public class FixBodyGenerator
{
    ...
    public FixBodyGenerator(String file, String name )
    {
      ...
      try
      {
	    ...
	    if( !type.equals("String") )
	    {
            ...
            writer.println("\t{");
	    if( type.equals("Date"))
	            writer.println("\t\taddBodyField( "+num+", "+" get"+format+"String( _"+field+"));");
	    else
		    writer.println("\t\taddBodyField( "+num+", "+" getString( _"+field+"));");	
            writer.println("\t}");
	    writer.print("\t");
	    }
	    ...
	    //writer.print("\t");
            ...
            writer.println("\t{");
            writer.println("\t\taddBodyField( "+num+", "+" _"+field+");");
            writer.println("\t}");
	    ...
	    if( !type.equals("String") )
	    {
            ...
            writer.println("\t{");
	    if( type.equals("Date"))
	            writer.println("\t\t return ("+format+"StringTo"+type+"(getBodyFieldValue( "+num+" ))) ;");
	    else
	            writer.println("\t\t return (stringTo"+type+"(getBodyFieldValue( "+num+" ))) ;");
            writer.println("\t}");

	    writer.print("\t");
            writer.println("public String  get"+field+"AsString()");
            writer.println("\t{");
            writer.println("\t\t return (getBodyFieldValue( "+num+" )) ;");
            writer.println("\t}");
    ...
    {
        FixBodyGenerator c = new FixBodyGenerator( args[0], args[1] );
    }
}
