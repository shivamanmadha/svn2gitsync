 ...
 */
public class ICEMarketDataHandler {
	...
	private ICEBookHandler bookHandler = null;
	 ...
	 */
	public ICEMarketDataHandler(MarketDataNotifier mdn)
	{
		mdNotifier = mdn;
	}
    ...
    private void initializeData( String symbol )
    {
		...
		if(bookHandler == null)
		{
			bookHandler = new ICEBookHandler(mdNotifier);			
		}
		else
		{
