...
/**
* This class is used to represent the FIX message TraderLogoutResponse
*
*/
public class FixTraderLogoutResponse extends FixMessage {

	/**
	* Constructor to construct FixTraderLogoutResponse object 
	*
	*/
	public FixTraderLogoutResponse() {
		setMessageType(FixConstants.FIX_MSGTYPE_TRADER_LOGOUT_RESPONSE);
		setMsgType(FixConstants.FIX_MSGTYPE_TRADER_LOGOUT_RESPONSE);
	}
