...
/**
* This class is used to represent the FIX message Order
*
*/
public class FixOrder extends FixMessage {
	/**
	* Constructor to construct FixOrder object 
	*
	*/
	public FixOrder() {

		setMessageType(FixConstants.FIX_MSGTYPE_ORDER);
		setMsgType(FixConstants.FIX_MSGTYPE_ORDER);
	}
	/**
	...
	*/
	...
	/**
	* setter method to set ProcessCode
	*
	* @param String - ProcessCode
	*/
	public void setProcessCode(String _ProcessCode) {
		addBodyField(81, _ProcessCode);
	}
	/**
	* getter method to get ProcessCode
	*
	* @return String - ProcessCode
	*/
	public String getProcessCode() {
		return (getBodyFieldValue(81));
	}
	/**
	...
	*/
	...
	/**
	* setter method to set IOIid
	*
	* @param String - IOIid
	*/
	public void setIOIid(String _IOIid) {
		addBodyField(23, _IOIid);
	}
	/**
	* getter method to get IOIid
	*
	* @return String - IOIid
	*/
	public String getIOIid() {
		return (getBodyFieldValue(23));
	}
	/**
	* setter method to set QuoteID
	*
	* @param String - QuoteID
	*/
	public void setQuoteID(String _QuoteID) {
		addBodyField(117, _QuoteID);
	}
	/**
	* getter method to get QuoteID
	*
	* @return String - QuoteID
	*/
	public String getQuoteID() {
		return (getBodyFieldValue(117));
	}
	/**
