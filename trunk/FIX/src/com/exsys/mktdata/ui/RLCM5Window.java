...
public class RLCM5Window
  	extends RLCMarketDataBaseHandler
  	implements ListSelectionListener
{
  // ========================================================================
  // ========================================================================
  public RLCM5Window() throws ConfigFileNotFound, Exception
  {
      //processConfig();
    super();
  ...
  private void processConfig()
  {
    try
    {
      ...
      mResponseSubject = ConfigurationService.getValue("M5ResponseSubject");
...
{
	System.out.println("processM5Message");
	//System.out.println(rlcMsg.toString());
	mListModel.addElement(rlcMsg);

}

public void processRestoredM5Message(RLCM5Message rlcMsg)
{

	processM5Message(rlcMsg);
}
  ...
  public void valueChanged(ListSelectionEvent e)
  {
      ...
      if(selected >= 0)
      {
        RLCM5Message item = (RLCM5Message)mList.getModel().getElementAt(selected);
        displayMessage(item);
      }
  ...
  public void displayMessage(RLCM5Message msg)
  {
  ...
  private void restoreFromFile()
  {
    try
    {
      ...
      String restore = ConfigurationService.getValue("restoreM5");
      if(restore.equals("Y"))
      {
 	     String inFile = ConfigurationService.getValue("M5InLogFile");
 	     ArrayList inList = RLCFileManager.getRLCMessagesList(inFile,"M5");

 	     // then process in list
 	    for(int i=0; i<inList.size();i++)
	    {
	    	System.out.println("Restoring");
    		RLCM5Message msg = (RLCM5Message)inList.get(i);
	    	processRestoredM5Message(msg);
	    }
  ...
  public Component createComponent()
  {
	...
	mainPanel.setBorder(
      BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder("< M5Message Display:>"),
        BorderFactory.createEmptyBorder(0,0,0,0)
      )
    );
