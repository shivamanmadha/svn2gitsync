...
public class ICEMktDataWindow
  extends BaseGUIApplication
  implements MarketDataMessageProcessor,  ActionListener,
  			 SecuritiesMessageProcessor, MarketDataNotifier
{
  ...
  // ========================================================================
  // ========================================================================
  public ICEMktDataWindow(String args[]) throws ConfigFileNotFound, Exception
  {
    super(args);
      processConfig();
      ...
      mTheFrame = new JFrame("ICE MktData Window");
...
{
	return processMarketDataFullRefresh(msg,  null);
}
public boolean processMarketDataFullRefresh(FixMarketDataFullRefresh msg, String restoreSymbol)
{
	
	mListModel.addElement("MARKET DATA FULL REFRESH");
    Logger.debug("processMarketDataFullRefresh");
    ...
    if(msg.getNoMDEntries() > 0 )
    {
    	...
    	mdHandler.processFullRefresh(symbol,msg);
...
public void processMarketDataSecurityStatus(FixSecurityStatus msg)
{
  ...
  {
    mMarketDataWindow = new MktDataWindow(mTargetCompID, mSenderCompID, mSenderSubID, mTraderName,this,mUniqueIDFile,mExchange);
  ...
  private void initializeSession()
  {
    try
    {
      mdHandler = new ICEMarketDataHandler(this);
      //mdHandler = new ICEFullMarketDataHandler();
      mSessionMgr = new MarketDataSessionManager();
  ...
  private MarketDataSessionManager mSessionMgr = null;
  ...
  //private ICEFullMarketDataHandler mdHandler = null;
  ...
  private MktDataWindow mMarketDataWindow = null;
