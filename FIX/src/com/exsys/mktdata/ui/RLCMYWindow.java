...
public class RLCMYWindow
  	extends RLCMarketDataBaseHandler
  	implements ListSelectionListener
{
  // ========================================================================
  // ========================================================================
  public RLCMYWindow() throws ConfigFileNotFound, Exception
  {
      //processConfig();
    super();
...
public void processRestoredMYMessage(RLCMYMessage rlcMsg)
{
  ...
  public void valueChanged(ListSelectionEvent e)
  {
      ...
      {
      	clearWindow();
        RLCMYMessage item = (RLCMYMessage)mList.getModel().getElementAt(selected);
        displayMessage(item);
      }
  ...
  public void displayMessage(RLCMYMessage msg)
  {
