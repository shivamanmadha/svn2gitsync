...
public class RLCMABookWindow
  	extends RLCMarketDataBaseHandler
  	implements ListSelectionListener
{
  // ========================================================================
  // ========================================================================
  public RLCMABookWindow() throws ConfigFileNotFound, Exception
  {
      //processConfig();
    super();
...
public void processRestoredMAMessage(RLCMAMessage rlcMsg)
{
  ...
  public void displayMessage(String symbol)
  {
	  ...
	  RLCMABookRow[] rows = bh.getMABook(symbol);
	  if(rows != null)
	  {
  ...
  public Component createComponent()
  {
   ...
   // System.out.println("OrderWindow::createComponent");
	...
	JLabel lblL = new JLabel("Level   " + RLCMABookRow.toHeaderString());
	...
	lblL1 = new JLabel("Level 1  0     0@0.00    0    0@0.00");
	...
	lblL2 = new JLabel("Level 2  0     0@0.00    0    0@0.00");
	...
	lblL3 = new JLabel("Level 3  0     0@0.00    0    0@0.00");
	...
	lblL4 = new JLabel("Level 4  0     0@0.00    0    0@0.00");
	...
	lblL5 = new JLabel("Level 5  0     0@0.00    0    0@0.00");
