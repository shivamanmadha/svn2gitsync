...
public class ICEFullMktDataWindow
  			 ...
  			 SecuritiesMessageProcessor, MarketDataNotifier
{
  ...
  // ========================================================================
  // ========================================================================
  public ICEFullMktDataWindow(String args[]) throws ConfigFileNotFound, Exception
  {
    super(args);
      processConfig();
...
public void processMarketDataSecurityStatus(FixSecurityStatus msg)
{
  ...
  private void initializeSession()
  {
    try
    {
      ...
      mdHandler = new ICEFullMarketDataHandler(this);
