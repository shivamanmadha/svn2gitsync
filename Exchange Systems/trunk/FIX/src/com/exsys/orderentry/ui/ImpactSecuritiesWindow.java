...
public class ImpactSecuritiesWindow implements ActionListener
{
  private ImpactMessageProcessor mSecWin = null;
  ...
  public ImpactSecuritiesWindow(String targetCompID,
                     String SenderCompID,String SenderSubID,String UserName,
                     ImpactMessageProcessor secwin,
                     String idFile,
  ...
  private void submitRequest() throws Exception
  {
         ...
         String value = (String)secTypesMap.get(mSecurityType);
         pdRequest.MarketType = Short.valueOf(value).shortValue();
         pdRequest.RequestSeqID = Integer.parseInt(idGen.getNextSecId());


    if(mSecWin != null) mSecWin.processProductDefinitionRequest(pdRequest);
  }
  // ========================================================================
  // ========================================================================
