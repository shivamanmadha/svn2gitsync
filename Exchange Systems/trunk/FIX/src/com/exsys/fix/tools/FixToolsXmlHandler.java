 ...
 */
public class FixToolsXmlHandler implements DocumentHandler {

	private UserManager userManager = null;
	private ArrayList otList = null;
	private ArrayList tifList = null;
	

	//private StringBuffer buffer;
	//private int state;
	private UserDetails user = null;
	private OrderTypeDef otDef = null;
	private TimeInForceDef tifDef = null;

/**
 * FixFieldXmlHandler constructor comment.
 */
public FixToolsXmlHandler(UserManager newManager,
						  ArrayList newOrderTypesList,
						  ArrayList newTIFList)
{
	super();
	userManager = newManager;
	otList = newOrderTypesList;
	tifList = newTIFList;
