...
public class RLCMHWindow
  	extends RLCMarketDataBaseHandler
  	implements ListSelectionListener
{
  // ========================================================================
  // ========================================================================
  public RLCMHWindow() throws ConfigFileNotFound, Exception
  {
      //processConfig();
    super();
  ...
  private void processConfig()
  {
    try
    {
      ...
      mResponseSubject = ConfigurationService.getValue("MHResponseSubject");
...
{
	System.out.println("processMHMessage");
	//System.out.println(rlcMsg.toString());
	mListModel.addElement(rlcMsg);

}

public void processRestoredMHMessage(RLCMHMessage rlcMsg)
{

	processMHMessage(rlcMsg);
}
  ...
  public Component createResponseLog()
  {
    ...
    areaScrollPane.setBorder(
      BorderFactory.createCompoundBorder(
        BorderFactory.createCompoundBorder(
          BorderFactory.createTitledBorder("MH Messages Log"),
  ...
  public void valueChanged(ListSelectionEvent e)
  {
      ...
      if(selected >= 0)
      {
        RLCMHMessage item = (RLCMHMessage)mList.getModel().getElementAt(selected);
        displayMessage(item);
      }
  ...
  public void displayMessage(RLCMHMessage msg)
  {
  ...
  private void restoreFromFile()
  {
    try
    {
      ...
      String restore = ConfigurationService.getValue("restoreMH");
      if(restore.equals("Y"))
      {
 	     String inFile = ConfigurationService.getValue("MHInLogFile");
 	     ArrayList inList = RLCFileManager.getRLCMessagesList(inFile,"MH");

 	     // then process in list
 	    for(int i=0; i<inList.size();i++)
	    {
	    	System.out.println("Restoring");
    		RLCMHMessage msg = (RLCMHMessage)inList.get(i);
	    	processRestoredMHMessage(msg);
	    }
  ...
  public Component createComponent()
  {
	...
	mainPanel.setBorder(
      BorderFactory.createCompoundBorder(
        BorderFactory.createTitledBorder("< MHMessage Display:>"),
        BorderFactory.createEmptyBorder(0,0,0,0)
      )
    );
